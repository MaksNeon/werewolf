...
{
    /// <summary>
    /// @file MaitreDuJeux.cs
    /// @brief Classe de gestion du maître de jeu pour le jeu Loups-Garous.
    /// @author Maksym Ptytsia, Oscar Calvo
    /// @date 21-05-2024
    /// </summary>
    public class MaitreDuJeux
    {
        // class properties and fields documentation
        ...
        /// @brief Constructeur pour MaitreDuJeux.
        public MaitreDuJeux()
        {
        ...
        /// <summary>
        /// @brief Démarre le jeu en appelant JouerTour.
        ...
        /// <summary>
        /// @property proprieter pour la checkbox
        /// </summary>
        ...
        /// <summary>
        /// @brief Supprime les villageois morts de la liste Village.
        ...
        /// <summary>
        /// @brief Boucle principale du jeu, contrôlant le déroulement des tours.
        ...
        /// <summary>
        /// @brief Gère le tour de la sorcière.
        /// @param cible Index de la cible à potentiellement sauver ou empoisonner.
        ...
        /// <summary>
        /// @brief Gère le tour des loups-garous, sélectionnant une victime.
        /// @return L'index de la victime choisie.
        ...
        /// @brief Gère les actions de jour, incluant les votes des villageois.
        /// </summary>
        void TourJour()
        {
            if (!GameEnd)
        ...
        /// @brief Tue un villageois sélectionné.
        /// @param villageois Le villageois à tuer.
        /// </summary>
        ...
        /// @brief Exécute un tour normal incluant les actions nocturnes et diurnes.
        /// </summary>
        void TourNormal()
        {
            Application.DoEvents();
        ...
        /// @brief Gère le tour initial, incluant l'action de Cupidon.
        /// </summary>
        void TourInit()
        {
            EndormirAll();
        ...
        /// @brief Gère le tour de Cupidon, choisissant deux amoureux.
        /// </summary>
        void TourCupidon()
        {
        ...
        /// @brief Endort un villageois spécifique.
        /// @param villageois Le villageois à endormir.
        /// </summary>
        ...
        /// @brief Réveille tous les villageois.
        /// </summary>
        void WakeUpAll()
        {
            foreach (Villageois villageois in Village)
        ...
        /// @brief Réveille un villageois spécifique.
        /// @param villageois Le villageois à réveiller.
        /// </summary>
        ...
        /// @brief Endort tous les villageois.
        /// </summary>
        void EndormirAll()
        {
            foreach (Villageois villageois in Village)
        ...
        /// @brief Crée un village avec des rôles attribués à partir d'une liste de noms d'utilisateur.
        /// @param Username Liste des noms d'utilisateur.
        /// </summary>
